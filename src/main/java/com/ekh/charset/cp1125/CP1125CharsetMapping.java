 ...
 */
public class CP1125CharsetMapping {
    static short cp1125_2uni[] = {
          /* 0xb0 */
    ...
    public static int decode( int c )
    {
        if (c < 0x80)
            ...
            return cp1125_2uni[c-0xb0];
    }

    public static int encode( int wc ) {
        if (wc < 0x0080) {
            return wc;
        }
        else if (wc >= 0x00a0 && wc < 0x00b8)
            return cp1125_page00[wc-0x00a0];
        else if (wc >= 0x0400 && wc < 0x0498)
            return cp1125_page04[wc-0x0400];
        else if (wc == 0x2116)
            return 0xfc;
        else if (wc == 0x221a)
            return 0xfb;
        else if (wc >= 0x2500 && wc < 0x25a8)
            return cp1125_page25[wc-0x2500];
